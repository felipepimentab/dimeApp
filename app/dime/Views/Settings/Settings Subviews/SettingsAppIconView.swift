...
struct SettingsAppIconView: View {
  ...
  let options: [AppIconBundle] = [
    AppIconBundle(
      ...
      displaySubtitle: String(localized: "Designed by the brilliant @rudra_dsigns, check out his work on Twitter.")),
    AppIconBundle(
      actualFileName: "AppIcon2", exampleFileName: "AppIcon2_EG", displayName: "Unicorn",
      displaySubtitle: String(localized: "Dime definitely isn't becoming one but it never hurts to keep dreaming.")),
    AppIconBundle(
      actualFileName: "AppIcon3", exampleFileName: "AppIcon3_EG", displayName: "V1.5",
      displaySubtitle: String(localized: "An early prototype also designed by @rudra_dsigns that I kinda fancy.")),
    AppIconBundle(
      actualFileName: "AppIcon4", exampleFileName: "AppIcon4_EG", displayName: "O.G.",
      displaySubtitle: String(localized: "Haphazardly put together in under 30 minutes, the original Dime icon."))
  ]
